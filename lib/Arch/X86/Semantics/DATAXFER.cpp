...
DEF_ISEL(LDDQU_XMMdq_MEMdq) = MOVDQx<V128W, MV128>;

#if HAS_FEATURE_AVX
DEF_ISEL(VLDDQU_XMMpd_MEMdq) = MOVDQx<VV128W, MV128>;
DEF_ISEL(VLDDQU_YMMdd_MEMdd) = MOVDQx<VV256W, MV256>;
#endif  // HAS_FEATURE_AVX
...
DEF_ISEL(MOVZX_GPR16_MEMw) = MOVZX<R16W, M16>;
DEF_ISEL(MOVZX_GPR32_MEMw) = MOVZX<R32W, M16>;
IF_64BIT(DEF_ISEL(MOVZX_GPR64_MEMw) = MOVZX<R64W, M16>;)
...
DEF_ISEL(MOVSX_GPR16_MEMw) = MOVSX<R16W, M16, int16_t>;
DEF_ISEL(MOVSX_GPR32_MEMw) = MOVSX<R32W, M16, int32_t>;
IF_64BIT(DEF_ISEL(MOVSX_GPR64_MEMw) = MOVSX<R64W, M16, int64_t>;)
...
IF_64BIT(DEF_ISEL(MOVSXD_GPR64_MEMd) = MOVSX<R64W, M32, int64_t>;)
...
DEF_ISEL(VPMOVSXBQ_XMMi64_MASKmskw_MEMi8_AVX512) =
    VPMOVSXBQ_MASKmskw_SIMD128<VV128W, R8, MV16>;
DEF_ISEL(VPMOVSXBQ_XMMi64_MASKmskw_XMMi8_AVX512) =
    VPMOVSXBQ_MASKmskw_SIMD128<VV128W, R8, V128>;
DEF_ISEL(VPMOVSXWD_XMMi32_MASKmskw_MEMi16_AVX512) =
    VPMOVSXWD_MASKmskw_SIMD128<VV128W, R8, MV64>;
DEF_ISEL(VPMOVSXWD_XMMi32_MASKmskw_XMMi16_AVX512) =
    VPMOVSXWD_MASKmskw_SIMD128<VV128W, R8, V128>;
